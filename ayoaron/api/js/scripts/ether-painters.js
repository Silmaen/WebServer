...
Timeline.GregorianEtherPainter.prototype.paint = function() {
    ...
    var dsys     = this._band._dateSystem;
    SimileAjax.DateTime.roundDownToInterval(minDate, this._unit, timeZone, this._multiple, this._theme.firstDayOfWeek, dsys);
    
    var p = this;
    var incrementDate = function(date) {
        for (var i = 0; i < p._multiple; i++) {
            SimileAjax.DateTime.incrementByInterval(date, p._unit,0,p._band._dateSystem);
        }
    };
...
Timeline.HotZoneGregorianEtherPainter.prototype.paint = function() {
    ...
    var incrementDate = function(date, zone) {
        for (var i = 0; i < zone.multiple; i++) {
            SimileAjax.DateTime.incrementByInterval(date, zone.unit,0,p._band._dateSystem);
        }
    };
    ...
    for (var z = zStart; z <= zEnd; z++) {
        ...
        SimileAjax.DateTime.roundDownToInterval(minDate2, zone.unit, timeZone, zone.multiple, this._theme.firstDayOfWeek, this._band._dateSystem);
        SimileAjax.DateTime.roundUpToInterval(  maxDate2, zone.unit, timeZone, zone.multiple, this._theme.firstDayOfWeek, this._band._dateSystem);
