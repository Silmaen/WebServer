...
(function() {
            ...
            var parseURLParameters = function(parameters) {
                ...
                for (var p = 0; p < params.length; p++) {
                    ...
                    if (pair[0] == "locales") {
                        ...
                        bundle = pair[1] != "false";
                    } else if (pair[0] == "timeline-use-local-resources") {
                        useLocalResources = pair[1] != "false";
                    }
                }
            };
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ?
            "api/ajax/api/simile-ajax-api.js?bundle=false" :
            "http://static.simile.mit.edu/ajax/api-2.2.1/simile-ajax-api.js";
