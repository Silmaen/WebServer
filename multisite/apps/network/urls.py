...
urlpatterns = [
    ...
    path("credentials/<uuid:pk>/edit/", views.GatewayCredentialUpdateView.as_view(), name="credential-update"),
    path("credentials/<uuid:pk>/delete/", views.GatewayCredentialDeleteView.as_view(), name="credential-delete"),
    path("credentials/<uuid:pk>/test/", views.GatewayCredentialTestView.as_view(), name="credential-test"),
]
